...
export async function getExistingEmails(emails) {
...
export async function getExistingProjectNames(projectNames) {
...
export async function getExistingRepositoryNames(repositoryNames) {
