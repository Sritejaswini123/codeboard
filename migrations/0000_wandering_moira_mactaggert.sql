...
CREATE INDEX "commits_commit_message_idx" ON "commits" USING btree ("commit_message");--> statement-breakpoint
CREATE INDEX "commits_user_id_idx" ON "commits" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX "repositories_title_idx" ON "repositories" USING btree ("title");--> statement-breakpoint
